...
pub fn StatPage() -> impl IntoView {
    view! {
        <div class="space-y-8">
            ...
            <section>
                <h2 class="text-xl font-semibold mb-4">"Horizontal Stats"</h2>
                <Stats>
                    <Stat>
            ...
            <section>
                <h2 class="text-xl font-semibold mb-4">"Vertical Stats"</h2>
                <Stats vertical=true>
                    <Stat>
            ...
            <section>
                <h2 class="text-xl font-semibold mb-4">"Stats with Figures"</h2>
                <Stats>
                    <Stat>
            ...
            <section>
                <h2 class="text-xl font-semibold mb-4">"Stats with Actions"</h2>
                <Stats>
                    <Stat>
            ...
            <section>
                <h2 class="text-xl font-semibold mb-4">"Dashboard Stats Example"</h2>
