...
pub fn MockupPhonePage() -> impl IntoView {
    view! {
        <div class="space-y-8">
            ...
            <section>
                <h2 class="text-xl font-semibold mb-4">"Basic Phone"</h2>
            ...
            <section>
                <h2 class="text-xl font-semibold mb-4">"With App Interface"</h2>
                <div class="flex justify-center">
                    <MockupPhone>
                            ...
                            <div class="flex flex-col h-full">
                                ...
                                <div class="flex-1 p-4 space-y-4 overflow-auto">
                                    ...
                                    <Chat position={ChatPosition::End}>
                                        <ChatBubble color={ChatBubbleColor::Primary}>"I'm good, thanks!"</ChatBubble>
            ...
            <section>
                <h2 class="text-xl font-semibold mb-4">"Login Screen"</h2>
                <div class="flex justify-center">
                    <MockupPhone>
