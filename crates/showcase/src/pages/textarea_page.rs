    ...
    view! {
        <div class="space-y-10">
            ...
            <section class="space-y-4">
                <ComponentPreview
                    title="Colors"
                    code=r##"<Textarea placeholder="Default textarea" rows=3 />
...
<Textarea color={Color::Error} placeholder="Error" rows=3 />"##
            ...
            <section class="space-y-4">
                <ComponentPreview
                    title="Sizes"
                    code=r##"<Textarea size={Size::ExtraSmall} placeholder="Extra Small" rows=2 />
...
<Textarea size={Size::ExtraLarge} placeholder="Extra Large" rows=5 />"##
            ...
            <section class="space-y-4">
                <ComponentPreview
                    ...
                    code=r##"<Textarea variant={Variant::Outline} placeholder="Bordered / outline style" rows=3 />
...
<Textarea readonly=true value="Readonly note content" rows=3 />"##
            ...
            <section class="space-y-4">
                <ComponentPreview
                    title="With fieldset and helper text"
                    code=r##"<Fieldset legend="Project summary">
    <Textarea
        name="summary"
        rows=4
    ...
    <p class="label">"Keep it under 500 characters."</p>
            ...
            <section class="space-y-4">
                <ComponentPreview
                    ...
                    code=r##"let (bio, set_bio) = signal(String::new());
