        ...
        <div class="space-y-10">
            ...
            <section class="space-y-4">
                ...
                <ClassTable entries=vec![
                    ClassEntry { name: "validator", type_label: "base", description: "Base validator wrapper component" },
                    ClassEntry { name: "validator-hint", type_label: "base", description: "Hint message inside validator" },
                ] />
            </section>
