    ...
    view! {
        <div class="space-y-8">
            ...
            <section class="space-y-4">
                <h2 class="text-xl font-semibold">"Light Variant"</h2>
            ...
            // --- Dark Variant ---
            <section class="space-y-4">
                <h2 class="text-xl font-semibold">"Dark Variant"</h2>
                <div class="border border-base-300 rounded-box overflow-hidden">
                    <div class="h-[24rem]">
            ...
            // --- Primary Variant ---
            <section class="space-y-4">
                <h2 class="text-xl font-semibold">"Primary Variant"</h2>
                <div class="border border-base-300 rounded-box overflow-hidden">
                    <div class="h-[24rem]">
            ...
            // --- Width Variations ---
            <section class="space-y-4">
                <h2 class="text-xl font-semibold">"Width Variations"</h2>
            ...
            <section class="space-y-4">
                ...
                <div class="mockup-code text-sm">
                    <pre data-prefix="1"><code>"<SidebarLayout variant=SidebarLayoutVariant::Dark open_on_large=true>"</code></pre>
                    <pre data-prefix="2"><code>"  <SidebarLayoutContent>"</code></pre>
                    <pre data-prefix="3"><code>"    <SidebarLayoutTopBar>"</code></pre>
                    <pre data-prefix="4"><code>"      <SidebarLayoutMobileMenuButton />"</code></pre>
                    <pre data-prefix="5"><code>"    </SidebarLayoutTopBar>"</code></pre>
                    <pre data-prefix="6"><code>"    <SidebarLayoutMain>"</code></pre>
                    <pre data-prefix="7"><code>"      // Main content"</code></pre>
                    <pre data-prefix="8"><code>"    </SidebarLayoutMain>"</code></pre>
                    <pre data-prefix="9"><code>"  </SidebarLayoutContent>"</code></pre>
                    <pre data-prefix="10"><code>"  <SidebarLayoutSide>"</code></pre>
                    <pre data-prefix="11"><code>"    <SidebarLayoutOverlay />"</code></pre>
                    <pre data-prefix="12"><code>"    <SidebarLayoutPanel>"</code></pre>
                    <pre data-prefix="13"><code>"      <SidebarLayoutHeader>"Logo"</SidebarLayoutHeader>"</code></pre>
                    <pre data-prefix="14"><code>"      <SidebarLayoutNav>"</code></pre>
                    <pre data-prefix="15"><code>"        <SidebarLayoutNavSection title=\"Main\">"</code></pre>
                    <pre data-prefix="16"><code>"          <SidebarLayoutNavItem href=\"/\" active=true>"Home"</SidebarLayoutNavItem>"</code></pre>
                    <pre data-prefix="17"><code>"        </SidebarLayoutNavSection>"</code></pre>
                    <pre data-prefix="18"><code>"      </SidebarLayoutNav>"</code></pre>
                    <pre data-prefix="19"><code>"      <SidebarLayoutFooter>"User"</SidebarLayoutFooter>"</code></pre>
                    <pre data-prefix="20"><code>"    </SidebarLayoutPanel>"</code></pre>
                    <pre data-prefix="21"><code>"  </SidebarLayoutSide>"</code></pre>
                    <pre data-prefix="22"><code>"</SidebarLayout>"</code></pre>
                </div>
            </section>
        </div>
    }
