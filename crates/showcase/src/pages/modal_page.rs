    ...
    view! {
        <div class="space-y-10">
            ...
            <section class="space-y-4">
                <h2 class="text-xl font-semibold">"Dialog pattern (daisyUI)"</h2>
                <p class="text-sm text-base-content/60">
                    "This mirrors the docs approach using native `showModal()` for interactive demo behavior."
                </p>
            ...
            <section class="space-y-4">
                <h2 class="text-xl font-semibold">"Forced open/close states"</h2>
                <div class="grid gap-4 lg:grid-cols-2">
                    <Modal state={ModalState::Open} class="!static !inset-auto !grid">
            ...
            <section class="space-y-4">
                <h2 class="text-xl font-semibold">"Action layouts"</h2>
