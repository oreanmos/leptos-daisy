...
pub fn MaskPage() -> impl IntoView {
    view! {
        <div class="space-y-8">
            ...
            <section>
                <h2 class="text-xl font-semibold mb-4">"Geometric Shapes"</h2>
            ...
            <section>
                <h2 class="text-xl font-semibold mb-4">"Stars"</h2>
            ...
            <section>
                <h2 class="text-xl font-semibold mb-4">"Hexagons"</h2>
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
                    <div class="flex flex-col items-center gap-2">
            ...
            <section>
                <h2 class="text-xl font-semibold mb-4">"Polygons"</h2>
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                    <div class="flex flex-col items-center gap-2">
            ...
            <section>
                <h2 class="text-xl font-semibold mb-4">"Arch & Heart"</h2>
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                    <div class="flex flex-col items-center gap-2">
            ...
            <section>
                <h2 class="text-xl font-semibold mb-4">"With Other Content"</h2>
