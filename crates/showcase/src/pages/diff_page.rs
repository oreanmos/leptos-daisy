        ...
        <div class="space-y-10">
            ...
            <section class="space-y-4">
                <ComponentPreview
                    ...
                    code=r#"<Diff class="aspect-video max-w-2xl">
    <DiffItem1>
        <img src="before.png" alt="Before" class="w-full h-full object-cover" />
    </DiffItem1>
    <DiffItem2>
        <img src="after.png" alt="After" class="w-full h-full object-cover" />
    </DiffItem2>
    <DiffResizer />
</Diff>"#
                >
            ...
            <section class="space-y-4">
                <ComponentPreview
                    ...
                    code=r#"<Diff class="aspect-[2/1] max-w-xl">
    <DiffItem1>
    ...
    <DiffResizer />
            ...
            <section class="space-y-4">
                <ComponentPreview
                    ...
                    code=r#"<Diff class="aspect-video max-w-lg">
    <DiffItem1>
