    ...
    view! {
        <div class="space-y-8">
            ...
            <section class="space-y-4">
                <h2 class="text-xl font-semibold">"Pattern 1: Sidebar with Secondary Column"</h2>
                <p class="text-sm text-base-content/60">
                    "Left sidebar + secondary navigation column + main content. "
                    "Ideal for complex applications with hierarchical navigation."
                </p>
                ...
                <div class="mockup-code text-sm">
                    <pre data-prefix="1"><code>"<SidebarShell>"</code></pre>
                    <pre data-prefix="2"><code>"  <Sidebar width=SidebarWidth::Narrow>"</code></pre>
                    <pre data-prefix="3"><code>"    // Icon-only navigation"</code></pre>
                    <pre data-prefix="4"><code>"  </Sidebar>"</code></pre>
                    <pre data-prefix="5"><code>"  <SecondaryColumn width=SecondaryColumnWidth::Wide variant=ColumnVariant::Muted>"</code></pre>
                    <pre data-prefix="6"><code>"    // Secondary navigation or filters"</code></pre>
                    <pre data-prefix="7"><code>"  </SecondaryColumn>"</code></pre>
                    <pre data-prefix="8"><code>"  <MainColumn>"</code></pre>
                    <pre data-prefix="9"><code>"    // Main content area"</code></pre>
                    <pre data-prefix="10"><code>"  </MainColumn>"</code></pre>
                    <pre data-prefix="11"><code>"</SidebarShell>"</code></pre>
                </div>
            </section>

            // --- Pattern 2: Three-Column with Header ---
            <section class="space-y-4">
                <h2 class="text-xl font-semibold">"Pattern 2: Three-Column with Header"</h2>
                <p class="text-sm text-base-content/60">
                    "Header bar + left sidebar + main content + right panel. "
                    "Perfect for dashboard-style applications with activity feeds."
                </p>
                <div class="border border-base-300 rounded-box overflow-hidden">
                ...
                <div class="mockup-code text-sm">
                    <pre data-prefix="1"><code>"<StackedShell>"</code></pre>
                    <pre data-prefix="2"><code>"  <PageHeader>"</code></pre>
                    <pre data-prefix="3"><code>"    // Top navigation bar"</code></pre>
                    <pre data-prefix="4"><code>"  </PageHeader>"</code></pre>
                    <pre data-prefix="5"><code>"  <MultiColumnShell>"</code></pre>
                    <pre data-prefix="6"><code>"    <Panel width=PanelWidth::Small>"</code></pre>
                    <pre data-prefix="7"><code>"      // Left sidebar"</code></pre>
                    <pre data-prefix="8"><code>"    </Panel>"</code></pre>
                    <pre data-prefix="9"><code>"    <MainColumn>"</code></pre>
                    <pre data-prefix="10"><code>"      // Main content"</code></pre>
                    <pre data-prefix="11"><code>"    </MainColumn>"</code></pre>
                    <pre data-prefix="12"><code>"    <RightPanel width=RightPanelWidth::Default breakpoint=Breakpoint::Large>"</code></pre>
                    <pre data-prefix="13"><code>"      // Right panel (lg+)"</code></pre>
                    <pre data-prefix="14"><code>"    </RightPanel>"</code></pre>
                    <pre data-prefix="15"><code>"  </MultiColumnShell>"</code></pre>
                    <pre data-prefix="16"><code>"</StackedShell>"</code></pre>
                </div>
            </section>

            // --- Pattern 3: Narrow Sidebar with Secondary ---
            <section class="space-y-4">
                <h2 class="text-xl font-semibold">"Pattern 3: Narrow Sidebar with Secondary"</h2>
                <p class="text-sm text-base-content/60">
                    "Icon-only sidebar + secondary column + main content + right panel. "
                    "Maximizes screen real estate while maintaining navigation depth."
                </p>
                <div class="border border-base-300 rounded-box overflow-hidden">
                    <div class="h-[24rem] flex">
                        // Icon Sidebar
                ...
                <div class="mockup-code text-sm">
                    ...
                    <pre data-prefix="3"><code>"    // Icon-only navigation"</code></pre>
                    <pre data-prefix="4"><code>"  </Sidebar>"</code></pre>
                    <pre data-prefix="5"><code>"  <SecondaryColumn width=SecondaryColumnWidth::Default>"</code></pre>
                    <pre data-prefix="6"><code>"    // Secondary navigation"</code></pre>
                    <pre data-prefix="7"><code>"  </SecondaryColumn>"</code></pre>
                    <pre data-prefix="8"><code>"  <MainColumn>"</code></pre>
                    <pre data-prefix="9"><code>"    // Main content"</code></pre>
                    <pre data-prefix="10"><code>"  </MainColumn>"</code></pre>
                    <pre data-prefix="11"><code>"  <RightPanel width=RightPanelWidth::Narrow breakpoint=Breakpoint::ExtraLarge>"</code></pre>
                    <pre data-prefix="12"><code>"    // Right panel (xl+)"</code></pre>
                    <pre data-prefix="13"><code>"  </RightPanel>"</code></pre>
                    <pre data-prefix="14"><code>"</SidebarShell>"</code></pre>
                </div>
            </section>

            // --- Pattern 4: Narrow Sidebar with Header and Secondary ---
            <section class="space-y-4">
                <h2 class="text-xl font-semibold">"Pattern 4: Narrow Sidebar with Header and Secondary"</h2>
                <p class="text-sm text-base-content/60">
                    "Icon sidebar + header + secondary column + main + right panel. "
                    "The most comprehensive layout for complex enterprise applications."
                </p>
                <div class="border border-base-300 rounded-box overflow-hidden">
                ...
                <div class="mockup-code text-sm">
                    <pre data-prefix="1"><code>"<SidebarShell>"</code></pre>
                    <pre data-prefix="2"><code>"  <Sidebar width=SidebarWidth::Narrow>"</code></pre>
                    <pre data-prefix="3"><code>"    // Icon-only sidebar"</code></pre>
                    <pre data-prefix="4"><code>"  </Sidebar>"</code></pre>
                    <pre data-prefix="5"><code>"  <div class=\"flex-1 flex flex-col\">"</code></pre>
                    <pre data-prefix="6"><code>"    <PageHeader>"</code></pre>
                    <pre data-prefix="7"><code>"      // Top navigation"</code></pre>
                    <pre data-prefix="8"><code>"    </PageHeader>"</code></pre>
                    <pre data-prefix="9"><code>"    <MultiColumnShell>"</code></pre>
                    <pre data-prefix="10"><code>"      <SecondaryColumn width=SecondaryColumnWidth::Narrow>"</code></pre>
                    <pre data-prefix="11"><code>"        // Secondary nav"</code></pre>
                    <pre data-prefix="12"><code>"      </SecondaryColumn>"</code></pre>
                    <pre data-prefix="13"><code>"      <MainColumn>"</code></pre>
                    <pre data-prefix="14"><code>"        // Main content"</code></pre>
                    <pre data-prefix="15"><code>"      </MainColumn>"</code></pre>
                    <pre data-prefix="16"><code>"      <RightPanel breakpoint=Breakpoint::ExtraLarge>"</code></pre>
                    <pre data-prefix="17"><code>"        // Right panel (xl+)"</code></pre>
                    <pre data-prefix="18"><code>"      </RightPanel>"</code></pre>
                    <pre data-prefix="19"><code>"    </MultiColumnShell>"</code></pre>
                    <pre data-prefix="20"><code>"  </div>"</code></pre>
                    <pre data-prefix="21"><code>"</SidebarShell>"</code></pre>
                </div>
            </section>
            ...
            <section class="space-y-4">
                ...
                <div class="space-y-2">
                    <h3 class="text-lg font-medium">"Main + Right Panel"</h3>
                    <div class="border border-base-300 rounded-box overflow-hidden">
                ...
                <div class="space-y-2">
                    <h3 class="text-lg font-medium">"Three Columns"</h3>
                    <p class="text-sm text-base-content/60">"Left navigation panel, main content, and right details panel."</p>
                    <div class="border border-base-300 rounded-box overflow-hidden">
